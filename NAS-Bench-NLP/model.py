...
class AWDRNNModel(torch.nn.Module):
    ...
    def __init__(self, rnn_type, ntoken, ninp, nhid, nlayers, 
        ...
        self.decoder = torch.nn.Linear(nhid, ntoken) #changed here
#         self.decoder = torch.nn.Linear(nhid, 1)
...
#         self.decoder.weight.data.fill_(0.1)
    ...
    def init_hidden(self, bsz, wght):
        ...
        for i in range(self.nlayers):
            ...
            hidden.append(tuple([weight.new(1, bsz, hidden_size).fill_(wght) for _ in range(hidden_tuple_size)]))
